...
class FaceIt:
    ...
    def convert(self, video_file, swap_model = False, max_frames = None):
...
class FaceSwapInterface:
    ...
    def train(self, input_a_dir, input_b_dir, model_dir):
        ...
        args_str = args_str.format(input_a_dir, input_b_dir, model_dir, 512)
        self._run_script(args_str)
...
#faceit.convert('bezos_alexa_lost_her_voice.mp4')
